...
const tapData = [
    {'lk_column_id': 1, 'lk_column_name': '全部订单', 'status': ''},
    {'lk_column_id': 2, 'lk_column_name': '正常订单', 'status': 1},
    {'lk_column_id': 3, 'lk_column_name': '异常订单', 'status': 0}
]
    ...
    render () {
        ...
        return <div className="order-main">
            ...
            <div className="order-tab">
                ...
                {!list.length ? <div className="not-order">
                    {/* 没有订单 */}
                    <div>
                        ...
                        {list.map((item, index) => (
                            <div key={index} className="items">
                                ...
                                <div className="buy-info">
                                    ...
                                    <span>合计&nbsp;&nbsp;{toFixed2((item.lk_goods_sprice) * (item.lk_nummber))}</span>
                                </div>
