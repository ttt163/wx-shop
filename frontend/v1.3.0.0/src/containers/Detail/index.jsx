            ...
            <div className="detail-main">
                ...
                <div className="h69 edit-count">
                    ...
                    <div>
                        ...
                        <div>
                            <a className={_lquery.lk_goods_type !== '1' || query.num < 2 ? 'disabled' : ''} href="javascript:void(0)" onClick={() => _lquery.lk_goods_type !== '1' || query.num < 2 ? '' : this.changeNum('reduce', query.num)}>
                            ...
                            <a className={_lquery.lk_goods_type !== '1' || query.num >= info.lk_quota_count ? 'disabled' : ''} href="javascript:void(0)" onClick={() => _lquery.lk_goods_type !== '1' || query.num >= info.lk_quota_count ? '' : this.changeNum('add', query.num)}>
                ...
                <div className="pay">
                    ...
                    <a className="btn-yellow" onClick={() => !Cookies.get('isLogin') ? dispatch(showLogin(true)) : this.goPay()}>去付款</a>
                </div>
            </div>
