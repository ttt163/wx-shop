...
import {NavKey, goodsPlatform} from '../../public/config'
...
class Main extends Component {
    ...
    render () {
        ...
        let pType = !$.cookie('gamePlatform') ? 'iOS' : $.cookie('gamePlatform')
        let tag = $.cookie('gameName') ? <Tag onClick={this.handleClick} color="#108ee9" className="game-id">欢迎来到<span className="name"> {props.other.game.gameName}（{goodsPlatform[pType]}） </span>  后台系统</Tag> : ''
        return <Layout>
            <MainHeader tag={tag} />
            <Layout>
