...
class GoodsList extends Component {
            ...
            render: (text, record) => {
                return <div>
                    ...
                    {/* <div className="clearfix">
                        <div className="f-left">{record.lk_goods_name}</div>
                        {record.lk_goods_quota.toLocaleLowerCase() !== 'no' ? <div className="platform-box"><i className={`iconfont iconfont-${record.lk_goods_quota.toLocaleLowerCase()}`}></i></div> : (
                            <div className="platform-box"><i className="iconfont iconfont-ios"></i><i className="iconfont iconfont-android"></i></div>
                        )
                        }
                    </div> */}
                </div>
    ...
    getPlatformIcon = (val) => {
        let str = `<i className="iconfont iconfont-ios"></i><i className="iconfont iconfont-android"></i>`
        let type = val.toLocaleLowerCase()
        if (type === 'ios') {
            str = `<i className="iconfont iconfont-ios"></i>`
        } else if (type === 'android') {
            str = `<i className="iconfont iconfont-android"></i>`
        }
        return str
    }
