...
import { gameIdCookie, formatDate, toFixed2, URL, GOODSTYPE, fomatUrlQuery, axiosAjax } from '../../public/index'
                        ...
                        <Row className="bbdot">
                            <Col span="21">
                                ...
                                <Row>
                                    ...
                                    <Col className="lh32" span={5} >{orderInfo.lk_goods_type !== '1' ? '' : `每${quotaType[orderInfo.lk_quota_type]}限购${orderInfo.lk_quota_count}个`}</Col>
                                </Row>
                                <Row>
